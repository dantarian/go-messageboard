...
type Board struct {
	...
	Status      BoardStatus `boil:"status" json:"status" toml:"status" yaml:"status"`
...
type whereHelperBoardStatus struct{ field string }

func (w whereHelperBoardStatus) EQ(x BoardStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperBoardStatus) NEQ(x BoardStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperBoardStatus) LT(x BoardStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperBoardStatus) LTE(x BoardStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperBoardStatus) GT(x BoardStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperBoardStatus) GTE(x BoardStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperBoardStatus) IN(slice []BoardStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
func (w whereHelperBoardStatus) NIN(slice []BoardStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var BoardWhere = struct {
	...
	Status:      whereHelperBoardStatus{field: "\"boards\".\"status\""},
	...
	DeletedAt:   whereHelpertime_Time{field: "\"boards\".\"deleted_at\""},
}
...
var (
	boardAllColumns            = []string{"id", "name", "status", "description", "created_at", "updated_at", "deleted_at"}
	boardColumnsWithoutDefault = []string{"name", "status", "created_at", "updated_at", "deleted_at"}
	boardColumnsWithDefault    = []string{"id", "description"}
